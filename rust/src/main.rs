...
use hal::pac;
use hal::prelude::*;
use hal::pwm::{tim1, tim2, tim3, tim8};
use hal::rcc::RccExt;
...
fn main() -> ! {
    ...
    //let pe9 = gpioe
        //.pe9
        //.into_af_push_pull(&mut gpioe.moder, &mut gpioe.otyper, &mut gpioe.afrl);
    ...
    let mut tim1_ch1 = tim1_channels.0.output_to_pe8(pe8);
    tim1_ch1.set_duty(tim1_ch1.get_max_duty()/20); // 5% duty cyle
    tim1_ch1.enable();
